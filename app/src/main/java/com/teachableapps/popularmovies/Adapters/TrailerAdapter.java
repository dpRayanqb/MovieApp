...
public class TrailerAdapter extends RecyclerView.Adapter<TrailerAdapter.TrailerViewHolder> {
    ...
    public interface ListItemClickListener {
        void OnListItemClick(TrailerModel trailerItem);
    }

    public TrailerAdapter(Context mContext, ArrayList<TrailerModel> items, ListItemClickListener listener) {
    ...
    public void setTrailerData(List<TrailerModel> trailerItemList) {
