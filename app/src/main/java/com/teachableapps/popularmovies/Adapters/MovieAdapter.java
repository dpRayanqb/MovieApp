package com.teachableapps.popularmovies.Adapters;
...
import com.teachableapps.popularmovies.R;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder> {
    ...
    private List<MovieModel> mMovieItemList;
    private final Context mContext;
    final private ListItemClickListener mOnClickListener;

    public interface ListItemClickListener {
        void OnListItemClick(MovieModel movieItem);
    }

    public MovieAdapter(List<MovieModel> movieItemList, ListItemClickListener listener, Context context) {
    ...
    public void setMovieData(List<MovieModel> movieItemList) {
//        Log.d(TAG,"Num movies: " + movieItemList.size());
    ...
    public class MovieViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void bind(int listIndex) {
            MovieModel movieItem = mMovieItemList.get(listIndex);
            listMovieItemView = itemView.findViewById(R.id.iv_item_poster);
