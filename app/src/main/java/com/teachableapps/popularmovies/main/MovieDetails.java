...
import com.teachableapps.popularmovies.Adapters.TrailerAdapter;
...
public class MovieDetails extends AppCompatActivity  implements TrailerAdapter.ListItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        movieItem = (MovieModel) intent.getSerializableExtra("movieItem");
        if (movieItem == null) {
    ...
    @Override
    public void OnListItemClick(TrailerModel trailerItem) {
